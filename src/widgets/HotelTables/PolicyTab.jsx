                    ...
                    <tbody>
                        {currentData.map((hotel, hotelIndex) => (
                            hotel.policies?.map((policy, index) => (
                                <tr key={index}>
                                    {/* Image */}
                                    {/* <td className="px-5 p-3 border-b border-blue-gray-50">
                                        <Avatar
                                            src={policy.image ? `${url}/Images/${policy.image}` : "/path/to/placeholder.jpg"}
                                            alt={policy.image}
                                            size="lg"
                                            variant="rounded"
                                    ...
                                    {/* policy Name */}
                                    <td className="px-5 py-5     border-b border-blue-gray-50 min-h-[100px]">
                                     ...
                                     {/* policy Name */}
                                     <td className=" py-5    border-b border-blue-gray-50 min-h-[100px]">
                                        <Typography variant="small" color="blue-gray" className="font-semibold">
                                            {policy.description}
                                        </Typography>
                                    </td>
