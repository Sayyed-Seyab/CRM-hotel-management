...
export default function CusisineTab() {
    const {url , Restaurants, language, cuisineId } = useContext(StoreContext)
  ...
  const currentData = Data.filter((cuisne)=> cuisne._id === cuisineId)
                            ...
                            restaurant.cuisines?.map((item, index) => (
                                <tr key={index}>
                                    ...
                                    <td className="px-5 p-4 border-b border-blue-gray-50">
                                        <Avatar
                                            src={item.cuisineimage ? `${url}/Images/${item.cuisineimage.url}` : "/path/to/placeholder.jpg"}
                                            alt={item.cuisineimage.url}
                                            size="lg"
                                            variant="rounded"
                                            className="w-20"
                                        />
